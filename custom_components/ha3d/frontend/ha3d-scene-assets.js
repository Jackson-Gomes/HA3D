...
async function saveAssets(panel, assets, status = null) {
  panel._config = await panel._hass.callApi("POST", "ha3d/scene_assets", { scene_assets: assets });
...
if (!proto.__ha3dSceneAssetsV1) {
  ...
  proto._uploadSceneAsset = async function (file) {
    ...
    try {
      const response = await this._hass.fetchWithAuth("/api/ha3d/scene_assets/upload", { method: "POST", body: form });
