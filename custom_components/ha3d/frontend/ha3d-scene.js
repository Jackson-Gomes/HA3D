...
const GLOBAL_LIGHT_TEMP_KEY = "ha3d_global_light_kelvin_v1";
const GLOBAL_LIGHT_POS_KEY = "ha3d_global_light_pos_v1";
...
if (!proto.__ha3dSceneLightTunedV4) {
  ...
  queueMicrotask(() => {
    document.querySelectorAll("ha3d-panel").forEach((panel) => {
